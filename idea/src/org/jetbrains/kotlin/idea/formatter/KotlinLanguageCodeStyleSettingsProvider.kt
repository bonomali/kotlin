...
class KotlinLanguageCodeStyleSettingsProvider : LanguageCodeStyleSettingsProvider() {
    ...
    override fun getConfigurableDisplayName() = KotlinBundle.message("codestyle.name.kotlin")
    override fun getDisplayPriority() = DisplayPriority.COMMON_SETTINGS
    override fun createConfigurable(settings: CodeStyleSettings, modelSettings: CodeStyleSettings): CodeStyleConfigurable =
        object : CodeStyleAbstractConfigurable(settings, modelSettings, KotlinLanguage.NAME) {
            override fun createPanel(settings: CodeStyleSettings): CodeStyleAbstractPanel =
                object : TabbedLanguageCodeStylePanel(KotlinLanguage.INSTANCE, currentSettings, settings) {
